...
#include "chess_interfaces/msg/detail/board_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const chess_interfaces::msg::BoardState & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.board_squares;
  }
  // Member: square_positions_3d
  {
    for (size_t i = 0; i < 64; i++) {
      geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.square_positions_3d[i],
        cdr);
    }
  }
  ...
  {
    cdr << ros_message.castling_rights;
  }
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  chess_interfaces::msg::BoardState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: board_squares
  {
    ...
    size_t item_size = sizeof(ros_message.board_squares[0]);
  ...
  // Member: square_positions_3d
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.square_positions_3d[index], current_alignment);
    }
  }
  // Member: white_to_move
  {
  ...
  {
    size_t array_size = 4;
    size_t item_size = sizeof(ros_message.castling_rights[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: en_passant_square
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = chess_interfaces::msg::BoardState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const chess_interfaces::msg::BoardState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<chess_interfaces::msg::BoardState *>(
    untyped_ros_message);
...
{
  return &chess_interfaces::msg::typesupport_fastrtps_cpp::_BoardState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, chess_interfaces, msg, BoardState)() {
  return &chess_interfaces::msg::typesupport_fastrtps_cpp::_BoardState__handle;
}
