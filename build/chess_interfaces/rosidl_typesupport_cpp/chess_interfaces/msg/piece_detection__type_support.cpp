...
static const _PieceDetection_type_support_symbol_names_t _PieceDetection_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, chess_interfaces, msg, PieceDetection)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, chess_interfaces, msg, PieceDetection)),
  }
};
...
{
  return &::chess_interfaces::msg::rosidl_typesupport_cpp::PieceDetection_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, chess_interfaces, msg, PieceDetection)() {
  return get_message_type_support_handle<chess_interfaces::msg::PieceDetection>();
}
